...
case "vertical":g=!0;l=!1;break;case "none":l=g=!1}g&&(k+="-count",j+="-count");g&&l&&(k+="-compact",j+="-compact");if(g&&typeof SHRSB_Globals!="undefined"&&SHRSB_Globals.perfoption=="1"){var i=this;if(l)this.style.marginRight="0px",d=document.createElement("div"),i=document.createElement("div"),f=this.parentNode,f.appendChild(i),i.className="shr_compact_div",d.className="shr_compact_tick",d.appendChild(document.createElement("s")),d.appendChild(document.createElement("i")),f.insertBefore(d,i);g&&
SHR4P.TB.utils.getTwitShrCnt(decodeURIComponent(c),function(a){i.innerHTML=a.count})}var n={title:e,link:c,short_link:c,shortener:SHRSB_Globals.shortener?SHRSB_Globals.shortener:"google",shortener_key:SHRSB_Globals.shortener_key?SHRSB_Globals.shortener_key:"",v:1,apitype:1,apikey:SHR4P.TB.shr_apiKey,twitter_template:SHR4P.TB.shr_twitter_template?SHR4P.TB.shr_twitter_template:"${title} - ${short_link}",service:7};[SHR4P.TB.shr_link,a.param(n)].join("?");a(this).before(a('<style type="text/css"> div.shareaholic a{background-image:url('+
